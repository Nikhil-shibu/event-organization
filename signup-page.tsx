...
export default function Component() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-950 via-blue-900 to-purple-950">
      ...
      <Card className="w-full max-w-lg relative backdrop-blur-sm bg-blue-900/50 border border-blue-800 shadow-2xl rounded-3xl text-blue-100">
        <CardHeader className="space-y-4 pb-6">
          ...
          <CardDescription className="text-center text-blue-200 text-base">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            ...
            {/* Student ID field */}
            <div className="space-y-2">
              <Label htmlFor="studentId" className="text-sm font-medium text-blue-200">
                Student ID
              </Label>
              <div className="relative">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm text-blue-200">
                I agree to the{" "}
                <Button variant="link" className="px-0 text-blue-400 hover:text-blue-300 h-auto p-0">
                  Terms & Conditions
                </Button>{" "}
                and{" "}
                <Button variant="link" className="px-0 text-blue-400 hover:text-blue-300 h-auto p-0">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-blue-900/50 px-2 text-blue-300">Or sign up with</span>
              </div>
            </div>
